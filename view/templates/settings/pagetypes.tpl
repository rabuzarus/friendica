...
{{if $account_organisation}}{{include file="field_radio.tpl" field=$account_organisation}}{{/if}}
{{if $account_news}}{{include file="field_radio.tpl" field=$account_news}}{{/if}}

{{if $account_community}}
